...
export function MobileNav() {
    ...
    return (
      ...
      shadow-[0px_-10px_0px_rgba(0,0,0,1)] z-100 md:hidden">
            ...
            <Link href={"/portfolio"}>
                <div className={`w-full flex flex-col items-center p-3 border-3 ${pathname.startsWith("/portfolio") ? "bg-main shadow-small border-black " : "border-transparent nav-hover"} mt-3`}>
                    <LiaBriefcaseSolid color={pathname.startsWith("/portfolio") ? "#ffffff" : "#000000"} size={30}/>
            ...
            <Link href={"/contact"}>
                <div className={`w-full flex flex-col items-center p-3 border-3 ${pathname.startsWith("/contact") ? "bg-main shadow-small border-black " : "border-transparent nav-hover"} mt-3`}>
