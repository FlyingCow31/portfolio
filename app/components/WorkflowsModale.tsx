    ...
    return (
            ...
            <div className={"flex flex-col items-center"}>
                <div className={"flex flex-row items-center mb-3"}>
                    <div className={"bg-main p-2 border shadow-small ml-3"}><BrainCircuit color="#ffffff" /></div>

                    <h1 className={"ml-3 text-white font-extrabold text-2xl"}>Workflows augmentés à l&#39;IA</h1>
                </div>

                <div>
                    <div className={"bg-white w-70 border shadow-small mb-3"}>
                        <div className={"flex gap-2 ml-3 pt-3 items-center"}>
                            <span className={"bg-main p-1 border"}><FastForward color="#ffffff" /></span>
                            <p className={"font-bold text-xl"}>Rapidité</p>
                        </div>
                    ...
                    <div className={"bg-white w-70 border shadow-small mb-3"}>
                        <div className={"flex gap-2 ml-3 pt-3 items-center"}>
                            <span className={"bg-main p-1 border"}><Focus color="#ffffff" /></span>
                            <p className={"font-bold text-xl"}>Focus</p>
                        </div>
                        <p className={"ml-3 mt-3 pb-3  font-semibold opacity-50"}>{texts[1]}</p>
                    </div>
                    <div className={"bg-white w-70 border shadow-small mb-3"}>
                        <div className={"flex gap-2 ml-3 pt-3 items-center"}>
                            <span className={"bg-main p-1 border"}><Bot color="#ffffff" /></span>
                            <p className={"font-bold text-xl text-main"}>L&#39;IA et moi</p>
                        </div>
                        <p className={"ml-3 mt-3 pb-3  font-semibold opacity-50"}>{texts[2]}</p>
                        <div className={"flex flex-col"}>
                            <h1 className={"ml-3 font-bold text-main text-2xl"}>Ma stack IA</h1>
