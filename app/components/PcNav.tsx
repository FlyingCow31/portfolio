...
export default function PcNav() {
    return (
        <nav className="hidden md:flex fixed top-0 left-0 h-screen border-red border-3 shadow-[11px_0px_0px_rgba(0,0,0,1)] flex-col justify-around items-center w-30 bg-white ">
