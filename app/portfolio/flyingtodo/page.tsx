    ...
    return (
        <main className={"bg-bg min-h-screen flex flex-col items-star pb-10 md:pb-0"}>
            ...
            <div className={'bg-white border-3 shadow-big w-[90%] mx-auto mt-25 pb-6 mb-10 md:ml-40 md:w-[80%] md:mt-10'}>
                ...
                <h1 className={"text-2xl font-extrabold m-3 md:text-3xl"}>Features</h1>
                ...
                <h1 className={"text-2xl font-extrabold m-3 md:text-3xl"}>Stack</h1>
                ...
                <h1 className={"text-2xl font-extrabold m-3"}>Liens</h1>
