     ...
     return (
          <main className={"bg-bg min-h-screen"}>
               ...
               <div className={"overflow-x-hidden h-full flex flex-col items-center md:ml-40 lg:ml-60 md:items-start"}>
                    <div
                         className={
                              "shadow-big bg-white border-3 border-black w-80 mt-10 mb-10 md:w-[90%] md:grid md:grid-cols-2"
                         }
                    >
                         <p
                              className={
                                   "border-3 border-black shadow-small bg-sec px-5 max-w-fit ml-3 mt-3 font-bold md:col-span-2 md:text-xl"
                              }
                         >
                              A PROPOS
                         </p>
                         ...
                         <p className={"ml-3 mt-3 mb-3 w-75 font-semibold md:text-xl md:w-60 lg:w-85"}>
                              J&#39;apporte une expertise à vos projets grâce à mon experience dans le domaine du web.
                              Mes workflows augmentés à l&#39;IA me permettent une rapidité tout en conservant une
                              fiabilité dans le code produit.
                         </p>
                         <hr className={"w-50 border border-main ml-auto mr-4 md:hidden"} />
                         <button
                              className={
                                   "text-main font-bold w-fit block ml-auto mr-4 pb-5 mt-2 cursor-pointer md:col-start-2 md:text-3xl md:mt-10 ctahover"
                              }
                         >
                    ...
                    <div className={"md:flex md:flex-col lg:flex-row md:gap-10 md:w-[100%] lg:w-[90%] md:pb-30 "}>
                         <div className={"flex flex-row gap-2 md:flex-col md:*:text-4xl md:gap-6 md:max-w-[90%] "}>
                              ...
                              {isDesktop && (
                                   <Link href={"/contact"} className={"md:mt-auto"}>
                                        <button
                                             className={
                                                  "font-title bg-main border-3 border-black shadow-small mb-30 mt-10 text-white p-3 font-bold md:mt-auto md:mb-0 clicanim"
                                             }
                                        >
                         ...
                         <div
                              className={
                                   "mt-10 pt-3 bg-bg h-fit w-80 border-3 border-black shadow-small flex flex-col items-center md:w-[90%] lg:w-[100%] md:mt-0 mx-auto min-w-0"
                              }
                         >
                    ...
                    {!isDesktop && (
                         <Link href={"/contact"}>
                              <button
                                   className={
                                        "font-title bg-main border-3 border-black shadow-small mb-30 mt-10 text-white p-3 font-bold clicanim"
                                   }
                              >
                                   Construisons ensemble!
                              </button>
